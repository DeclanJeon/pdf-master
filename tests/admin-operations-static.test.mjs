...
assert.match(toolPage, /프리미엄 기능입니다/, 'Premium tools should render a login/payment gate');
assert.match(toolPage, /const premiumFreeEnabled = isAdmin \|\| premium\.isPremium \|\| trialUnlimited \|\| trialRemaining > 0/, 'Premium tools should allow admin/premium or remaining trial usage');
